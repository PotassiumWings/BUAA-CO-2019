...
LAB20:    t476 = (t0 + 4092);
    ...
    *((unsigned int *)t486) = (t488 | t482);
    xsi_driver_vfirst_trans(t476, 0, 4);
    t489 = (t0 + 3844);
    *((int *)t489) = 1;
...
LAB126:    *((unsigned int *)t434) = 1;

LAB128:    memset(t422, 0, 8);
    t450 = (t434 + 4);
...
LAB134:    t471 = *((unsigned int *)t422);
    t472 = (~(t471));
    t473 = *((unsigned int *)t457);
    t474 = (t472 || t473);
    if (t474 > 0)
        goto LAB135;

LAB136:    if (*((unsigned int *)t457) > 0)
        goto LAB137;

LAB138:    if (*((unsigned int *)t422) > 0)
        goto LAB139;

LAB140:    memcpy(t421, t475, 8);
...
LAB135:    t475 = ((char*)((ng3)));
    goto LAB136;

LAB137:    xsi_vlog_unsigned_bit_combine(t421, 5, t461, 5, t475, 5);
    goto LAB141;

LAB139:    memcpy(t421, t461, 8);
    goto LAB141;
...
extern void work_m_00000000001468163143_2149527660_init()
{
	static char *pe[] = {(void *)Cont_54_0,(void *)Cont_57_1,(void *)Cont_63_2,(void *)Cont_71_3,(void *)Cont_75_4,(void *)Cont_82_5,(void *)Cont_90_6,(void *)Cont_94_7,(void *)Cont_101_8};
	xsi_register_didat("work_m_00000000001468163143_2149527660", "isim/mips_isim_beh.exe.sim/work/m_00000000001468163143_2149527660.didat");
