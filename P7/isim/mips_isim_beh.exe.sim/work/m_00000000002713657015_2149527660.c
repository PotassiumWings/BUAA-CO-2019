...
#endif
static const char *ng0 = "C:/Users/mumuy/Desktop/CO/p7-new/FORWARD.v";
...
LAB38:    xsi_vlog_unsigned_bit_combine(t49, 5, t63, 5, t77, 5);
    goto LAB42;

LAB40:    memcpy(t49, t63, 8);
    goto LAB42;
...
LAB16:    t278 = (t0 + 7708);
    ...
    *((unsigned int *)t288) = (t290 | t284);
    xsi_driver_vfirst_trans(t278, 0, 4);
    t291 = (t0 + 7504);
    *((int *)t291) = 1;
...
LAB49:    memcpy(t124, t103, 8);

LAB50:    memset(t152, 0, 8);
    t153 = (t124 + 4);
...
LAB93:    if (*((unsigned int *)t259) > 0)
        goto LAB94;

LAB95:    if (*((unsigned int *)t100) > 0)
        goto LAB96;

LAB97:    memcpy(t99, t277, 8);

LAB98:    goto LAB38;

LAB39:    xsi_vlog_unsigned_bit_combine(t21, 5, t85, 5, t99, 5);
    goto LAB43;
...
LAB94:    xsi_vlog_unsigned_bit_combine(t99, 5, t263, 5, t277, 5);
    goto LAB98;

LAB96:    memcpy(t99, t263, 8);
    goto LAB98;
...
extern void work_m_00000000002713657015_2149527660_init()
{
	static char *pe[] = {(void *)Cont_94_0,(void *)Cont_96_1,(void *)Cont_98_2,(void *)Cont_101_3,(void *)Cont_106_4,(void *)Cont_112_5,(void *)Cont_116_6};
	xsi_register_didat("work_m_00000000002713657015_2149527660", "isim/mips_isim_beh.exe.sim/work/m_00000000002713657015_2149527660.didat");
