...
LAB45:    if (*((unsigned int *)t71) > 0)
        goto LAB46;

LAB47:    memcpy(t70, t119, 8);
...
LAB42:    t112 = (t0 + 876U);
    ...
    t112 = ((char*)((ng0)));
    memset(t119, 0, 8);
    xsi_vlog_unsigned_add(t119, 32, t118, 32, t112, 32);
    goto LAB43;

LAB44:    xsi_vlog_unsigned_bit_combine(t70, 32, t113, 32, t119, 32);
    goto LAB48;

LAB46:    memcpy(t70, t113, 8);
    goto LAB48;

}


extern void work_m_00000000000688162399_0757879789_init()
{
	static char *pe[] = {(void *)Cont_33_0};
	xsi_register_didat("work_m_00000000000688162399_0757879789", "isim/mips_tb_beh.exe.sim/work/m_00000000000688162399_0757879789.didat");
